...
module.exports.getStartupParams = function() { console.log("process.argv=", process.argv);
    var app_params = {};
    ...
    for (var i = 2; i < process.argv.length; i++) {
        ...
        if (arg.indexOf('-p:') == 0) {
            ...
            var logParam = process.argv[i].replace("-log:", "");     console.log("logParam=",logParam);
        ...
        console.log("app_params.logDebug=",app_params.logDebug);
        console.log("app_params.logToConsole=",app_params.logToConsole);
    }
