    ...
    function (declare, View, Heading, ScrollableView, RoundRectList, ListItem, ToolBarButton, ProgressIndicator,Request) {
        return declare("PickUnitView", [View], {
           ...
           // pickUnitView: null,
            ...
            postCreate: function () {  console.log("postCreate detail view");
            ...
            setDetailContent: function (data) {
                var table = createMobTable(data, function(rowData){
                    console.log("rowData=",rowData);
                });
                this.domNode.appendChild(table);

                //this.list_items = new RoundRectList({"id": "list" + this.id, style: "position:relative"});
                //this.inner_scroll.domNode.appendChild(table);
                //this.inner_scroll.startup();
            ...
            //loadDetailContent: function (view_main) { console.log("loadDetailContent detail view");
            ...
            //    var instance = this;
            //
            //    Request.getJSONData({ ///mobile/rec/getDataForRecDTable
            //      url: "/mobile/rec/getRecData",
            //            //url: this.url+"/get_detail_view_data",
            //            condition:  "ChID~=" + instance.ChID,
            //            consoleLog: true
            //        }
            //
            ...
            loadDetailContent: function (view_main) { console.log("loadDetailContent detail view");
                ...
                Request.getJSONData({ ///mobile/rec/getDataForRecDTable
                        url: "mobile/rec/getDataForRecDTable",
                        //url: this.url+"/get_detail_view_data",
                        condition:  "ChID~=" + instance.ChID,
                        consoleLog: true
                    }
                    , function (success, result) {                                                                  console.log("loadDetailContentForView getJSONData=", result);
                        if (success) {
                            if (result.error) {
                                view_main.msgBox.innerHTML = "Нет данных";                                          console.log("loadDetailContentForView getJSONData DATA ERROR! error=", result.error);
                                view_main.dialogWin.show();
                            } else instance.setDetailContent(result);
